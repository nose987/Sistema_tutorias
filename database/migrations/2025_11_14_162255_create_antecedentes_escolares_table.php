...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('antecedentes_escolares', function (Blueprint $table) {
            ...
            $table->string('universidad_anterior_y_carrera_anterior', 150)->nullable();
            ...
            $table->text('necesita_apoyo_extra')->nullable()->comment('¿Has necesitado apoyo extra en alguna clase?');
