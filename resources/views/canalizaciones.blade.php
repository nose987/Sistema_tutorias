            ...
            <div x-data="{ activeTab: 'canalizaciones' }">
                ...
                <div>
                    <div x-show="activeTab === 'canalizaciones'"
                        ...
                        <div>
                            <h3 class="font-bold text-lg text-gray-800 dark:text-neutral-100">Historial de Canalizaciones</h3>
                            <p class="text-sm text-gray-500 dark:text-neutral-400">Registro completo de canalizaciones realizadas</p>
                        </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-600 dark:text-neutral-300">
                                ...
                                <tbody>
                                    <tr class="bg-white dark:bg-neutral-900 border-b dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800">
                                        ...
                                        <td class="px-6 py-4">10IDGS</td>
                                        <td class="px-6 py-4">Psicológico</td>
                                        <td class="px-6 py-4">21-03-2025</td>
                                        <td class="px-6 py-4">
                                            <div class="flex justify-end items-center space-x-4">
                                                <button class="text-gray-500 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                                        <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.022 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                                                    </svg>
                                                </button>
                                                <button class="text-gray-500 dark:text-neutral-400 hover:text-green-600 dark:hover:text-green-400 transition-colors">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div x-show="activeTab === 'bajas'"
                        class="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-neutral-700">
                        <div>
                            <h3 class="font-bold text-lg text-gray-800 dark:text-neutral-100">Bajas de alumnos</h3>
                            <p class="text-sm text-gray-500 dark:text-neutral-400">Registro de bajas</p>
                        </div>
                        <div class="overflow-x-auto mt-4">
                            <table class="w-full text-sm text-left text-gray-600 dark:text-neutral-300">
                                <thead class="bg-[#2B8A7F] text-xs text-white uppercase">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3">Fecha</th>
                                        <th scope="col" class="px-6 py-3">Motivo</th>
                                        <th scope="col" class="px-6 py-3">Canalizaciones</th>
                                ...
                                <tbody>
                                    <tr class="bg-white dark:bg-neutral-900 border-b dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800">
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 dark:text-neutral-100 whitespace-nowrap">
                                            Jose Guadalupe Llamas Padilla
                                        </th>
                                        <td class="px-6 py-4">10IDG</td>
                                        <td class="px-6 py-4">24-10-2024</td>
                                        <td class="px-6 py-4">Problemas económicos</td>
