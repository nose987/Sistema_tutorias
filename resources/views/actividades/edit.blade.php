            ...
            <div class="p-6">
                <form action="{{ route('actividades.update', $actividad) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $actividad->nombre) }}" required class="mt-1 block w-full border-gray-300 dark:border-neutral-600 dark:bg-neutral-800 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm dark:text-white">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha" id="fecha" value="{{ old('fecha', $actividad->fecha) }}" required class="mt-1 block w-full border-gray-300 dark:border-neutral-600 dark:bg-neutral-800 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm dark:text-white">
                    </div>

                    <div>
                        <label for="asistencia" class="block text-sm font-medium text-gray-700 dark:text-neutral-300">Asistentes</label>
                        <input type="number" name="asistencia" id="asistencia" value="{{ old('asistencia', $actividad->asistencia) }}" required min="0" max="99999" class="mt-1 block w-full border-gray-300 dark:border-neutral-600 dark:bg-neutral-800 rounded-md shadow-sm focus:ring-teal-500 focus:border-teal-500 sm:text-sm dark:text-white">
                    </div>
