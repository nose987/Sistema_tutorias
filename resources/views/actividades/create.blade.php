            ...
            <div class="p-6">
                <form action="{{ route('actividades.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" required class="w-full pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha" id="fecha" required class="w-full pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                    </div>

                    <div>
                        <label for="asistencia" class="block text-sm font-medium text-gray-700 dark:text-neutral-300">Asistentes</label>
                        <input type="number" name="asistencia" id="asistencia" required min="0" max="99999" class="w-full pr-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                    </div>
