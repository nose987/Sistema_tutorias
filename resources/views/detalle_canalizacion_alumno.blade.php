        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div
                ...
                <form action="{{ route('canalizaciones.seguimiento.store', $canalizacion) }}" method="POST"
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4 pt-4 border-t border-gray-200 dark:border-neutral-700">
                        ...
                        <div class="w-full md:w-auto">
                            ...
                            <label class="flex items-center text-sm text-gray-700 dark:text-neutral-200">
                                <input type="checkbox" name="finalizar_canalizacion" value="1"
                                    class="form-checkbox h-4 w-4 text-teal-600 border-gray-300 dark:border-neutral-600 rounded focus:ring-teal-500">
                                <span class="ml-2">Marcar esta canalización como 'Finalizada' / 'Cerrada'</span>
                            </label>
                            @else
                            <p class="text-sm font-medium text-gray-500 dark:text-neutral-400">
                                Esta canalización ya se encuentra 'Cerrada'.
                            </p>
                            @endif
                        </div>
